...
public class ActivityXMLParser extends AbstractScientiaXMLParser
{
    public ActivityXMLParser()
    {
        this.type = ScientiaObjectType.ACTIVITY;
    }

    public List<Activity> parse(InputStream scientiaEndPointXMLStream) throws IOException, ParserConfigurationException, SAXException
    {
