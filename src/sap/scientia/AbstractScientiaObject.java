...
public class AbstractScientiaObject
{
    protected String getStringFromNode(Node a, String nodeName)
    {
        return ((Element)a).getElementsByTagName(nodeName).item(0).getChildNodes().item(0).getNodeValue().trim();
    }
}
